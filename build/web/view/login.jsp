      ...
      <div class="row">
        ...
        <div class="col-10 col-sm-11 col-lg-4 col-md-10">
          <div class="container formLogin bg-secondary">
            ...
            <div class="text-center">
                <form class="p-3" action="../LoginController" method="POST"  onsubmit="validaLogin(this)" id="formLogin">
                    <div class="form-group">
                      	<label class="loginInput" for="InputLogin">Login</label>
                      	<input type="text" class="form-control" id="inputLogin" name="login"  aria-describedby="emailHelp">
